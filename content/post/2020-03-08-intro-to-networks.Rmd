---
title: 'A Brief Introduction to Network Analysis with Tidygraph'
author: G
date: '2020-03-08'
slug: intro-to-networks
categories: ["networks"]
tags: ["rstats", "network analysis", "tidygraph"]
description: 'An introduction to networks in R using the tidygraph, ggraph, and networkD3 packages'
---

```{r setup, include=FALSE, fig.align='center'}
#knitr::opts_chunk$set(echo = TRUE)
```
In this post I will you walk through the basics of working with network objects in R. We will first create a simple network as an example, manipulate it using tidygraph's very clean framework, and then do some simple plotting using ggraph and networkD3. Then we will step it up a bit and use some larger data and calculate some network metrics. 

My goal for this post is to show you how easily the simple manipulation steps from the simple example transfer over to the more complex, and allow us to simply carry out a lot of complex calculations with very little code.  

If you are familiar with the tidyverese's dplyr and ggplot packages you will be right at home using the tidygraph. 
